...
2) пишем код или нажимаем третью иконку между шрифтами и смайлами и у вас получается примерно вот так [url][/url]

3) правим этот код и делаем его вот таким[ Здесь ваш текст, название например ссылки ](ваша ссылка){:target="_blank"}
