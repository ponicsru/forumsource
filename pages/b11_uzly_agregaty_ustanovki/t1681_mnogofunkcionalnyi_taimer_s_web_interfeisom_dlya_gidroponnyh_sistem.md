...
> Я имел ввиду сама плата "таймер",хотя по тому,что выполняет данный девайс назвать его таймером пусть и многофункциональным язык не поворачивается, поставляется же без электродов измерения ес и рН,так вот где их брать?
