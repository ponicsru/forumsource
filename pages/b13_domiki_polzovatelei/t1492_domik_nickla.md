...
- Тактовая частота более 200Mhz
- Возможность работы по Wi-Fi
- Возможность работы по Ethernet
- Наличие возможности купить датчики: свет, температура, влажность, датчик воды
- Возможность приобрести GSM модем под данную платформу
- Возможность работы с флешками до 32Gb
